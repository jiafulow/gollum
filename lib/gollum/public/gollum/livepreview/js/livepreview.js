require([ 'ace/undomanager', 'ace/ext/static_highlight', 'ace/theme/github', 'ace/editor', 'ace/virtual_renderer', 'ace/theme/twilight',
'ace/mode/c_cpp', 'ace/mode/clojure', 'ace/mode/coffee', 'ace/mode/csharp', 'ace/mode/css', 'ace/mode/diff', 'ace/mode/golang', 'ace/mode/groovy', 'ace/mode/haskell', 'ace/mode/haxe', 'ace/mode/html', 'ace/mode/html_ruby', 'ace/mode/ini', 'ace/mode/java', 'ace/mode/javascript', 'ace/mode/json', 'ace/mode/julia', 'ace/mode/latex', 'ace/mode/less', 'ace/mode/liquid', 'ace/mode/lua', 'ace/mode/makefile', 'ace/mode/markdown', 'ace/mode/mysql', 'ace/mode/objectivec', 'ace/mode/ocaml', 'ace/mode/perl', 'ace/mode/pgsql', 'ace/mode/php', 'ace/mode/powershell', 'ace/mode/python', 'ace/mode/r', 'ace/mode/ruby', 'ace/mode/scala', 'ace/mode/scss', 'ace/mode/sh', 'ace/mode/sql', 'ace/mode/svg', 'ace/mode/tex', 'ace/mode/textile', 'ace/mode/text', 'ace/mode/xml', 'ace/mode/xquery', 'ace/mode/yaml'
], function() {
...
var languages = [
  'c_cpp', 'clojure', 'coffee', 'csharp', 'css', 'diff', 'golang', 'groovy', 'haskell', 'haxe', 'html', 'html_ruby', 'ini', 'java', 'javascript', 'json', 'julia', 'latex', 'less', 'liquid', 'lua', 'makefile', 'markdown', 'mysql', 'objectivec', 'ocaml', 'perl', 'pgsql', 'php', 'powershell', 'python', 'r', 'ruby', 'scala', 'scss', 'sh', 'sql', 'svg', 'tex', 'textile', 'text', 'xml', 'xquery', 'yaml'
  ];
  ...
  if ( codeElementsLength > 0 ) {
    for ( var idx = 0; idx < codeElementsLength; idx++ ) {
      ...
      if ( txt.length > 1 && codeHTML.match( /\n/ ) ) {
        ...
        if ( $.inArray( aceMode, languages ) === -1 ) {
